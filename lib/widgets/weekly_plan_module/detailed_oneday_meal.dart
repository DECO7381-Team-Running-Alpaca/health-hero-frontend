          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  'Total: ${((Provider.of<Meals>(context, listen: false).detailedPlan[widget.day][0].calories) + Provider.of<Meals>(context, listen: false).detailedPlan[widget.day][1].calories + Provider.of<Meals>(context, listen: false).detailedPlan[widget.day][2].calories).toStringAsFixed(2)}Kcal',
                  style: TextStyle(
                      fontSize: 20,
                      color: Color.fromRGBO(100, 110, 91, 1),
                      fontWeight: FontWeight.bold),
